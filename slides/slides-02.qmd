...
## Reshuffeling of the board

#### Ungleiche Gruppenaufteilung durch Kursaustritte
...
#### Eine Arbeitsdefinition & Kernbereiche ([GESIS](https://www.gesis.org/institut/digitale-verhaltensdaten))
...
Zur erfolgreichen Nutzung müssen **Forschungsziele & verfügbare Daten in Einklang** gebracht, mögliche [**Biases und methodische Probleme**]{.rn rn-type="highlight"} **berücksichttigt** sowie die [**Datenqualität**]{.rn rn-type="highlight"} **evaluiert** werden.
:::
