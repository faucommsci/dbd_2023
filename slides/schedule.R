...
# New schedule (C)
# - Update schedule due to cancelled session

## Create schedule
json_text_new_schedule_d <- '[
    {
        "Session": "",
        "Datum": "",
        "Topic": "**Introduction**",
    ...
    },
    {
        "Session": "10",
        "Datum": "17.01.2024",
        "Topic": "🔨 Automatic analysis of text in R",
        "Presenter": "Christoph Adrian"
    },
    {
        "Session": "11",
...
## Load schedule to environment
new_schedule_d <- fromJSON(json_text_new_schedule_d) %>% tibble()