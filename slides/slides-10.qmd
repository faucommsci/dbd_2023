...
3.  [📋 Hands on working with R](#exercises)

# What we did so far {#intro background-image="img/slide_bg-section.png"}

Analysis of tweets about digital disconnection on {{< fa brands twitter >}} (not 𝕏)
...
#### Along the tidy text pipeline: Tokenize ▶️ [Summarize]{.underline}
...
#### Along the tidy text pipeline: Tokenize ▶️ Summarize ▶️ [DTM]{.underline}
