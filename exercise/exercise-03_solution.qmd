...
::: callout-tip
Download source file: [![Quarto Document](/img/badge-quarto_document.svg)](https://github.com/faucommsci/dbd_2023/blob/main/exercise/exercise-03.qmd)

Open this exercise in other interactive and executable environments: [![Binder RStudio](/img/badge-binder_rstudio.svg)](https://mybinder.org/v2/gh/faucommsci/dbd_binder/HEAD/HEAD?urlpath=rstudio)
:::
